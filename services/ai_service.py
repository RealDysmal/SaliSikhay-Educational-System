...
def generate_quiz_from_topic(topic, num_questions=5):
    ...
    try:
        ...
        response_text = _call_gemini_api(prompt, model='gemini-2.5-flash', temperature=0.2, max_output_tokens=4000)
        ...
        if related_question_count < max(1, num_questions // 2):
            ...
            retry_text = _call_gemini_api(retry_prompt, model='gemini-2.5-flash', temperature=0.1, max_output_tokens=4000)
